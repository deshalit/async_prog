...
def parse_cve_record(content: dict) -> dict | None:
    ...
    result = {
        ...
        'date_updated': cve_meta_data['dateUpdated'],
...
def parse_cve_file(file_name: str) -> dict | None:
    with open(file_name, 'r') as f:
        content = json.load(f)
    return parse_cve_record(content)
